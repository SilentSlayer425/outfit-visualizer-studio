    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-6 text-foreground">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">2. Use License</h2>
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">3. User Content</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">4. Google Drive Integration</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">5. Account Termination</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">6. Disclaimer</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">7. Limitation of Liability</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">8. Changes to Terms</h2>
            <p className="text-muted-foreground leading-relaxed">
