    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-6 text-foreground">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">4. Data Storage and Security</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">5. Data Sharing and Third Parties</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">6. Your Data Rights</h2>
            <p className="text-muted-foreground leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">7. Cookies and Local Storage</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-heading font-semibold mb-3">8. Children's Privacy</h2>
            <p className="text-muted-foreground leading-relaxed">
